...
int main()
{
    ...
    */
    ...
    MemoryPool disk(1'200'000'000, BLOCKSIZE); 
    MemoryPool index(300'000'000, BLOCKSIZE);
    ...
    if (file.is_open())
    {
        ...
        while (std::getline(file, line))
        {
            ...
            //logging
//            cerr << "Inserted record " << recordNum + 1 << " at block address: " << &tempAddress.blockAddress << " and offset " << &tempAddress.offset << endl;
            recordNum += 1;
        }
        file.close();
    }
